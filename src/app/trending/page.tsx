...
export default function TrendingPage() {
    const { data, isLoading, error, refetch } = useTrendingDramas();

    return (
        <main className="min-h-screen pt-24 pb-20 container mx-auto px-4">
            <h1 className="text-3xl font-display font-bold text-white mb-8">Trending Now</h1>

            {error ? (
                <UnifiedErrorDisplay
                    title="Failed to load trending dramas"
